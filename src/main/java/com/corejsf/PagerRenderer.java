...
public class PagerRenderer extends Renderer {
	...
	public void encodeBegin(FacesContext context, UIComponent component)
		...
		for(int i = startPage; i < endPage; i++) {
			writeLink(writer, component, formId, id, "" + (i + 1), i == currentPage ? selectedStyleClass : styleClass);
		}
	...
	private void writeLink(ResponseWriter writer, UIComponent component,
			String formId, String id, String value, String styleClass) throws IOException {
	...
	private Object onclickCode(String formId, String id, String value) {
